...
<head>
    ...
    <style>
        ...
        main {
            background: url("<?= assetUrl('img/backGround.webp')?>");
        ...
        .right-cog .top, .right-cog .down, .right-cog .left, .right-cog .right, .right-cog .left-top, .right-cog .left-down, .right-cog .right-top, .right-cog .right-down {
        ...
        .right-cog .right-down {
            top: 27vmin !important;
        }
        ...
        .notPageDetails__error {
            color: #fff;
            font-size: 5vmin;
            font-weight: bold;
            animation: bulbing ease-in-out;
            animation-duration: 3s;
            animation-iteration-count: infinite;
        }

        .notPageDetails__desc {
            font-size: 3vmin;
            color: #999999;
            margin: 0 0 .4rem;
        }
        ...
        .button {
            background-color: #4e0de5;
            color: white;
            align-items: center;
            justify-content: center;
            font-size: 1.2vw;
            border: 1px solid #2f0889;
            border-radius: 10px;
            padding: 15px;
            margin-left: 15px;
            display: flex;
    ...
    <div class="NotPageContainer">
        <div>
            ...
            <div class="notPageDetails">
                <h2 class="notPageDetails__error">Error... !</h2>
                <p class="notPageDetails__desc">It Look Like Something Went Wrong...</p>
                <p class="notPageDetails__desc">Please You Sure The Address Is Currect !</p>
            </div>
