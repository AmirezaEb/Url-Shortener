        ...
        <div class="NotPageContainer">
            <div>
                ...
                <div class="notPageDetails">
                    <h2 class="notPageDetails__error"><?= Lang::get('header404') ?></h2>
                    <p class="notPageDetails__desc"><?= Lang::get('desc404ErrorBody') ?></p>
                    <p class="notPageDetails__desc"><?= Lang::get('footer404ErrorBody') ?></p>
                </div>
