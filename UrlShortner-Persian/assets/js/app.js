...
copyButton.addEventListener('click', event => {
  ...
  if (urlDetail.innerHTML) {
    Swal.fire({
      title: 'لینک کوتاه شما با موفقیت کپی شد!',
      icon: 'success',
      toast: true,
      position: 'top-end',
